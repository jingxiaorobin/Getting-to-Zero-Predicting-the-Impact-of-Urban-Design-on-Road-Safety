...
def run(args):
    train_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder('/gdrive/My Drive/Getting to Zero Capstone /VML/train', transform=data_transforms),
        batch_size=args.batch_size, shuffle=True, num_workers=4)                #n_worker to 4, to use 4 gpu

    val_loader = torch.utils.data.DataLoader(
        datasets.ImageFolder('/gdrive/My Drive/Getting to Zero Capstone /VML/val', transform=validation_data_transforms),
        batch_size=args.batch_size, shuffle=False, num_workers=4)               #n_worker to 4, to use 4 gpu
